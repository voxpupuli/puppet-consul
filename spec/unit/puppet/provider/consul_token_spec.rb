...
describe Puppet::Type.type(:consul_token).provider(:default) do
  let(:resource) do
    Puppet::Type.type(:consul_token).new(
      {
        name: 'test_token',
  ...
  describe '.flush' do
    context 'creation' do
      it 'creates token if not existing' do
        stub_request(:get, 'http://localhost:8500/v1/acl/tokens').
          with(headers: { 'X-Consul-Token' => 'e33653a6-0320-4a71-b3af-75f14578e3aa', 'User-Agent' => 'Ruby' }).
    ...
    context 'secret_id creation' do
      ...
      it 'sets secret_id if present' do
        stub_request(:get, 'http://localhost:8500/v1/acl/tokens').
          with(headers: { 'X-Consul-Token' => 'e33653a6-0320-4a71-b3af-75f14578e3aa', 'User-Agent' => 'Ruby' }).
          to_return(status: 200, body: JSON.dump([]), headers: {})
    ...
    context 'update' do
      it 'updates policies in case of missing policy ID' do
        list_response = [
          {
            'AccessorID' => '123123-1234-1234-1234-123456789',
      ...
      it 'updates policies in case of missing policy Name' do
        list_response = [
          {
            'AccessorID' => '123123-1234-1234-1234-123456789',
            'SecretID' => 'ebc71d90-7a30-4f83-b108-6c5d9bda3225',
      ...
      it 'updates policies in case of surplus policy' do
        list_response = [
          {
            'AccessorID' => '123123-1234-1234-1234-123456789',
            'SecretID' => 'ebc71d90-7a30-4f83-b108-6c5d9bda3225',
      ...
      it 'updates policies in case of other policy_name' do
        list_response = [
          {
            'AccessorID' => '123123-1234-1234-1234-123456789',
            'SecretID' => 'ebc71d90-7a30-4f83-b108-6c5d9bda3225',
    ...
    context 'delete' do
      it 'deletes absent existing token' do
        list_response = [
          {
            'AccessorID' => '123123-1234-1234-1234-123456789',
            'SecretID' => 'ebc71d90-7a30-4f83-b108-6c5d9bda3225',
      ...
      it 'does not delete absent non-existing token' do
        stub_request(:get, 'http://localhost:8500/v1/acl/tokens').
          with(headers: { 'X-Consul-Token' => 'e33653a6-0320-4a71-b3af-75f14578e3aa', 'User-Agent' => 'Ruby' }).
          to_return(status: 200, body: '[]', headers: {})
