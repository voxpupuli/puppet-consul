  ...
  describe '#create' do
    ...
    context 'when consul returns an error' do
      it 'should raise Puppet::Error on failed create' do
        ...
        described_class.prefetch(resources)
        resource.provider.create
        expect { resource.provider.flush }.to raise_error(Puppet::Error, %r{Session put: invalid return code 400 uri:})
      end
    end
  end
  ...
  describe '#destroy' do
    ...
    context 'when key exists, but consul returns an error' do
      it 'should raise error on failed delete' do
        ...
        expect { resource.provider.flush }.to raise_error(Puppet::Error, %r{Session delete: invalid return code 400 uri:})
      end
    end
  end
end
