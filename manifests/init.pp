...
# @param reload_command When set, use this exact command to reload the consul service instead of the module-computed one. Useful to work around environment-specific quirks (e.g. http/https scheme mismatches).
